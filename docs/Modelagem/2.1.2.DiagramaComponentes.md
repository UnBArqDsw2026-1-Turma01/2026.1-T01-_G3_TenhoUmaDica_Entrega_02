...
| Aluno          | Participação                                   |
| -------------- | ---------------------------------------------- |
| Diogo Oliveira | Criação e Validação do Diagrama de Componentes |
| João Gabriel   | Criação e Validação do Diagrama de Componentes |
| Felipe         | Criação e Validação do Diagrama de Componentes |
| Renan          | Criação e Validação do Diagrama de Componentes |
| Gabriel M.     | Criação e Validação do Diagrama de Componentes |

## Histórico de versão

| Versão | Descrição         | Autor(es)      |    Data    |
| :----: | :---------------- | :------------- | :--------: |
|  1.0   | Criação da Página | Diogo Oliveira | 24/04/2026 |
